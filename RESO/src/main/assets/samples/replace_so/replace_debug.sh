...
replace_debug() {
    ...
    mv /data/app/*/com.tencent.tmgp.sgamece*/lib/*/libtersafe.so /data/local/tmp/lib/armeabi-v7a/libtersafe.so.bak
    if [ $? != 0 ]; then
        mv /data/app/com.tencent.tmgp.sgamece*/lib/*/libtersafe.so /data/local/tmp/lib/armeabi-v7a/libtersafe.so.bak
    else
    ...
    mv /data/local/tmp/lib/armeabi-v7a/libtersafe.so /data/app/*/com.tencent.tmgp.sgamece*/lib/arm*/
    if [ $? != 0 ]; then
        mv /data/local/tmp/lib/armeabi-v7a/libtersafe.so /data/app/com.tencent.tmgp.sgamece*/lib/arm*/
        sha
    else
...
sha() {
    ...
    md5sum /data/app/*/com.tencent.tmgp.sgamece*/lib/*/libtersafe.so
    md5sum /data/app/com.tencent.tmgp.sgamece*/lib/*/libtersafe.so
}
